...
struct FatPunchParameters {
	...
	FatPunchParameters& operator=(const FatPunchParameters& params) {
		...
		//WHEN ADDING PARAM: add to both parts of this function, 
		//AND The setParameters function of the class
		if (this == &params)
			return *this;
...
public:
	...
	void setParameters(const FatPunchParameters& _parameters) {
		...
		compressorParams.threshold_dB = -42.0;
		compressorParams.outputGain = 6.0;
